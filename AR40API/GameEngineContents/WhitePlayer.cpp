...
void WhitePlayer::Start()
{
	...
	WhitePlayerCameraCollision = CreateCollision("PlayerCamera", { 1600, 1280 }, { 200, -50 });

	WhitePlayerHeadHitCollision = CreateCollision("WhitePlayerHeadHit", { 1, 2 }, { 0,-65 });//박스 충돌용(1개만 충돌하게끔)
